# 🏍️ Lean Angle Meter with Kalman Filter (MPU6050 + OLED)

A real-time **Lean Angle Meter** using an **MPU6050 IMU** and **SH1106 128×64 OLED display**, designed to measure and visualize motorcycle or bike lean angles.  
